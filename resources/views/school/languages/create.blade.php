...
<div class="card" style="max-width: 600px; margin: 0 auto;">
    <div class="card-header">
        <h2 class="card-title">Add School Language</h2>
    </div>

    <form method="POST" action="{{ route('school.school-languages.store') }}">
        @csrf
        <div class="form-group">
            <label for="name">Language Name (e.g., English, German, French) *</label>
        ...
        <div class="form-group">
            ...
            <p style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 8px;">Select teachers who will teach this language in your school.</p>
        ...
        <button type="submit" class="btn btn-primary" style="width: 100%; justify-content: center; padding: 12px; margin-top: 10px;">
            Save Language <i class='bx bx-check'></i>
        </button>
    </form>
</div>
@endsection
